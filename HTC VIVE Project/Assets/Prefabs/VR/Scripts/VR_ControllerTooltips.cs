...
namespace VR
{
    ...
    public class VRTK_ControllerTooltips : MonoBehaviour
    {
        ...
        {
            var actualController = VR_DeviceFinder.GetActualController(controllerActions.gameObject);
        ...
        {
            var controllerIndex = VR_DeviceFinder.GetControllerIndex(controllerActions.gameObject);
        ...
        private Transform GetTransform(Transform setTransform, SDK_BaseController.ControllerElements findElement)
        {
            ...
            {
                var modelController = VR_DeviceFinder.GetModelAliasController(controllerActions.gameObject);

                if (modelController && modelController.activeInHierarchy)
                {
                    var controllerHand = VR_DeviceFinder.GetControllerHand(controllerActions.gameObject);
