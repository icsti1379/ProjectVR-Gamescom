...
{
    /// <summary>
    /// This canvas adds a frames per second text element to the headset. To use the prefab it must be placed into the scene 
    /// then the headset camera needs attaching to the canvas:
    /// </summary>
    /// <remarks>
